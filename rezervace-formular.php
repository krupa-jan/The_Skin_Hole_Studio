...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/rezervace/formular.css">
</head>
...
<body>
    ...
    <section class="reservation-section">
        <div class="form-container">
            ...
            <form action="formular.php" method="POST" class="reservation-form">    
                ...
                <div id="cart-summary" class="summary-box"> </div>

                <input type="hidden" name="cart_data" id="cart-data-input">

                <script src="/assets/js/rezervace/kosik-formular.js"></script>
